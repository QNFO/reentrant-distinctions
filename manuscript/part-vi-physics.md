...
> **Mandates:** Ostrowski Dimensionless (§0.7) — all formulas in Planck units; MAP-TERRITORY-1 (§0.0) — every math-as-physics claim labeled
...
## End of Part VI (Draft v0.1)

### Drafting Notes (internal — remove before publication)

- **Citations verified (P3 gate):** Dirac 1928 (10.1098/rspa.1928.0023), von Neumann 1932 (book), Bekenstein 1973 (10.1103/physrevd.7.2333), Maldacena 1999 (10.1023/a:1026654312961), Page-Wootters 1983 (10.1103/physrevd.27.2885 — used in P4.T1 §5.3 discussion of no-cloning, to be cited in second pass).
- **To add in second pass:** Schrödinger 1930 (zitterbewegung), Ryu-Takayanagi 2006, Maldacena-Susskind 2013, Hawking 1975.
- **Ostrowski Dimensionless mandate (§0.7):** ALL physics formulas presented in Planck units with dimensional form for recognizability. Verified: $S = A/4$, $E_0 = \omega/2$, $\omega_C = m$, $\lambda_C = 1/m$. No dimensional-only formulas.
- **MAP-TERRITORY-1:** All math-as-physics claims labeled. [TERRITORY] labels: §23.1 (vacuum = Gaussian eigenform), §24.1 (mass = re-entry frequency), §26.2 (measurement = trace). All carry falsifiability conditions. [MAP] labels applied where the claim is analogical.
- **Certainty labels:** applied inline. **Banned words check:** none used.
- **Critical risks (from P1 audit):** §24 (Compton frequency as re-entry) is the HIGH-risk map-territory claim — the [TERRITORY] label and falsifiability condition are in place. §27 (holography) is MEDIUM risk — labeled [MAP] + [mainstream interpretation].

### Known Risks (from P1 audit)

- §24 is the single most dangerous claim in the treatise — must pass KIF-60: the claim's evidential weight must be assessed against the null (standard quantum mechanics predicts the same phase). The section's honest position: re-description, no new prediction, falsifiability structural not observational.
- §26's measurement section must not claim new physics — it is a modal re-description, flagged [not yet falsifiable] as physical claim.
