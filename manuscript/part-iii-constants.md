...
Part I introduced the unit circle as the phase space of the re-entrant mark (§4.2) [MAP — model]. Part III now shows that $\pi$ is not merely *pictured* by the circle but *computed* by the trace structure of the circle type.
